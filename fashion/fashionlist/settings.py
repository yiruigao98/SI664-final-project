...
WSGI_APPLICATION = 'fashionlist.wsgi.application'
...
try:
    ...
    print('When you want to use social login, please see fashionlist/github_settings-dist.py')
